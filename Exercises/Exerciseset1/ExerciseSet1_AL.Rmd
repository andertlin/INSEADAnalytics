...
**Your Answers here:**
<br>
1. This is done in dataSet1.R. In the file the code pulls the stock tickers SPY and AAPL.<br>
2. round(100*sum(StockReturns[,2]),1)<br>
   [1] 380.4<br>
   round(100*mean(StockReturns[,2]),3)<br>
   [1] 0.137<br>
   round(100*sd(StockReturns[,2]),3)<br>
   [1] 2.189<br>
3. Yes, we just need to modify the code in dataSet1.R to pull YHOO, too.
<br>
...
<br>
1. 
  dim(transposedData)<br>
  [1]    2 2773<br>
2.
```{r eval = FALSE, echo=TRUE}
  portfolio_new = apply(transposedData,2,mean)
  names(portfolio_new) <- colnames(transposedData)
...
**Your Answers here:**
<br>
1. startDate = "2001-01-01"<br>
2. Yes, update the tickers and rerun the code in dataSet1.R<br>
<br>
...
**Your Answers here:**
<br>
1. sum(myData != StockReturns[1:20,]) <br>
   [1] 20<br>
2. sum(myData != StockReturns[1:40,])<br>
[1] 20<br>
<br>
<br>
