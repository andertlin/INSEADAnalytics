...
**Your Answers here:**
<br>
1. This is done in dataSet1.R. In the file it pulls the stock tickers SPY and AAPL.
<br>
2. round(100*sum(StockReturns[,2]),1)
   [1] 380.4
   ...
   [1] 2.189
<br>
3. Yes, we just need to modify the code to pull YHOO, too.
<br>
...
[1]    2 2773
<br>
2.portfolio_new = apply(transposedData,2,mean)
...
<br>
2. Yes, update the tickers and rerun the code in dataSet1.R
<br>
<br>
...
1. sum(myData != StockReturns[1:20,]) 
   [1] 20
<br>
2. there is a syntax error in the code
<br>
<br>
