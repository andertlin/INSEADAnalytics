...
**Your Answers here:**
1. First it breaks down the time series data into windows. Then it calculates the moving averages of those windows. Transform the ma into 1, 0, and -1 and sum them together. If it is postive then you long that future. If it is negative you short. Scale the daily investments so they add up to $1 everyday.  
2. 
```{r echo=TRUE, eval=TRUE, comment=NA, warning=FALSE,error=FALSE, message=FALSE, prompt=FALSE, tidy=TRUE}
