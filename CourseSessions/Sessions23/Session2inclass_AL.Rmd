...
##### Answers:
1. Yes and yes.  
2. We don't need all the question responses in our data analysis.
<br>
<br>
<br>
...
**Your Answers here:**
1. The percentage of variance explained by the components. We can use this to decided which components to included in our data analysis.  
2. It cannot be increasing because they should add up to 100.
3. The preference to see many components that expalin the variance in the data not just a handful.
<br>
<br>
<br>
...
**Your Answers here:**
1. status and experience. yes.  
2. 5 or more.
3. 3- brand. 4- reliability. 5- practicality
4. data sciense allows business managers to extract meaningful information from a bunch of numbers in a scientific way.
<br>
<br>
<br>
<br>
...
**Your Answers here:**
1. 3 segments or more.  
2. seg1-advanced/influencer; seg2-rich; seg3-adventurous/influencer.  
3. I could include more segments in the analysis.  
4. This is just one peice of the data we can use for decision making. it's better to have more context before we make business recommendations. In general, reliability, brand, and price are important acorss all three segments.
<br>
<br>
<br>
<br>
